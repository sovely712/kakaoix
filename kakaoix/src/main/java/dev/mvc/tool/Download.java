...
public class Download extends javax.servlet.http.HttpServlet {
  ...
  protected void doProcess(HttpServletRequest request,
    ...
    try {
      ...
      // 락이 걸려 있음으로 배치처리로 삭제해야함.
//      File file_del = new File(dir + "/" + filename);
//      
//      if (file_del.exists()) {  // 다운로드 후 파일 삭제
//        System.out.println("file_del.canRead(): " + file_del.canRead());
//        System.out.println("file_del.delete(): " + file_del.delete());
//
//      }
